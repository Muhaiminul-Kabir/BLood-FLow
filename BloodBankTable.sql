...
insert into DONOR values(donor_sequence.nextval,'Anika',21,'Female','AB','+','Iskaton','67 BNP Office', '01275347688','Yes');
...
BEGIN
	DBMS_OUTPUT.PUT_LINE('Enter (1) to SEARCH ');
	DBMS_OUTPUT.PUT_LINE('Enter (A) to  Admin');
	DBMS_OUTPUT.PUT_LINE('Enter (2) to INSERT DONOR ');
	DBMS_OUTPUT.PUT_LINE('Enter (3) to UPDATE DONOR ');
	DBMS_OUTPUT.PUT_LINE('Enter (4) to DELETE DONOR ');
END;
/